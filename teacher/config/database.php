...
class Database
{
    ...
    {;
        $query = "
SELECT S.STUDENT_ID,S.USERNAME,S.FIRST_NAME,S.LAST_NAME, RE.EXAM_ID,T.TOTAL AS SCORE, Q.TOTAL AS WEIGHT, C.COURSE_NAME AS COURSE_NAME FROM TBL_RESULT AS RE 
...
INNER JOIN (SELECT SUM(MARKS) AS TOTAL FROM TBL_QUESTION WHERE EXAM_ID = $exam_id) Q 
