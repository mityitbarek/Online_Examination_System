                ...
                <div class="ques">
                    ...
                    <form method="post" action="">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col">
                                    <button name='previous' class=" btn btn-lg btn-success">&laquo; Previous</button>
                                ...
                                <div class="col"></div>
                                <div class="col">
                                    <button name='next' class=" btn btn-lg btn-success"> Next &raquo;</button>
                                </div>
                                <div class="col">
                    ...
                    if (isset($_POST['next'])) {
                        ...
                        echo "previous question can't be there. ";
                        $tbl_name = "tbl_question";
                        $where = "";
                    }
                    ?>
