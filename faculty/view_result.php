                ...
                <div class="report">
                    ...
                    <?php 
                        ...
                        while($row=$obj->fetch_data($res))
                        {
                            ...
                            <?php 
                                ...
                                {
                                    ?>
                                    <label style="color: green;"><?php echo $userAnswer; ?></label><span class="fa fa-lg fa-circle-check"></span>
                                    <?php
                                }
                                else
                                {
                                    ?>
                                    <label style="color: red;"><?php echo $userAnswer; ?></label><i class="fa fa-lg fa-times-check"></i>
                                    <?php
                                }
                            ?>
                            ...
                            <label>Correct Answer:</label><label style="color: green;"><?php echo $rightAnswer; ?></label><br />
                                ...
                                <?php 
                                    if($reason!="")
                                    {
                                        echo "<div class='alert alert-success'>".$reason."</div>";
                                    }
                                ?>
                            <hr />
                            <?php
                    ...
                    ?>
                        <a href="<?php echo SITEURL; ?>admin/index.php?page=dashboard">
                            <button type="button" class="btn btn-lg btn-primary">Go Home</button>
                        </a>
