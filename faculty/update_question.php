            ...
            <div class="content">
                <div class="report">
                    ...
                    <form method="post" action="" class="forms" enctype="multipart/form-data">
                        ...
                        <input type="submit" name="submit" value="Update Question" class="btn btn-lg btn-success" style="margin-left: 15%;" />
                        <a href="<?php echo SITEURL; ?>admin/index.php?page=questions"><button type="button" class="btn btn-lg btn-danger">Cancel</button></a>
                    </form>
                    <?php 
                        if(isset($_POST['submit']))
                        {
                            ...
                            if($res===true)
                            {
                                $_SESSION['update']="<div class='alert alert-success'>Question successfully updated.</div>";
                                header('location:'.SITEURL.'admin/index.php?page=questions');
                            }
                            else
                            {
